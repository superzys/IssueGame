...
var LoginRewardPage = (function (_super) {
    ...
    function LoginRewardPage() {
        var _this = _super.call(this) || this;
        // this.Cstage = cStage;
        _this.name = "LoginRewardPage";
        _this.addEventListener(eui.UIEvent.COMPLETE, _this.uiCompHandler, _this);
        _this.skinName = "resource/Pages/LoginRewardPage.exml";
        return _this;
    }
    LoginRewardPage.prototype.uiCompHandler = function () {
        ...
        // this.verticalCenter
        var dsListHeros = UserManger.getInstance().userInfoObj.GetLoginReward();
    ...
    LoginRewardPage.prototype.SendMsgToServer = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reqNet, Msg, getData, resNet, resNetObj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        reqNet = new WxLoginRewardReqNet();
                        reqNet.SessonId = UserManger.getInstance().userInfoObj.UserGameInfo.SessonId;
                        Msg = JSON.stringify(reqNet);
                        return [4 /*yield*/, HttpFetch.getInstance().HttpPost("GainLoginReward", Msg)];
                    case 1:
                        getData = _a.sent();
                        if (getData != undefined) {
                            resNet = JSON.parse(getData);
                            if (resNet.msg != undefined) {
                                resNetObj = JSON.parse(resNet.msg);

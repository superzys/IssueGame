...
var HttpFetch = (function () {
    ...
    HttpFetch.getInstance = function () {
        if (this.instance == null) {
            this.instance = new HttpFetch();
        }
        return this.instance;
    };
    HttpFetch.prototype.SetHttpUrl = function (url) {
        this.baseHttp = url;
    };
    // var params = "{'UserName':'张三', 'Pwd': '10'}";
    HttpFetch.prototype.HttpPost = function (url, params, responseType) {
    ...
    HttpFetch.prototype.HttpGet = function (url, params, responseType) {
        if (params === void 0) { params = ""; }
        if (responseType === void 0) { responseType = egret.HttpResponseType.TEXT; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
...
__reflect(HttpFetch.prototype, "HttpFetch");
